...
fontpath = os.path.join(os.path.dirname(__file__), 'symbols/wx_symbols.ttf')
wx_symbol_font = fm.FontProperties(fname=fontpath)
...
# Add total sky cover
wx_code_map.update({'SKC': 0, 'CLR': 0, 'FEW': 2, 'SCT': 4, 'BKN': 6, 'OVC': 8,})
